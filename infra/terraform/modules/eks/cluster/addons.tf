# ADDONS MOVIDOS PARA envs/dev/eks-addons.tf
# Para garantir que sejam criados APÓS os node groups estarem prontos
# Isso evita que o CoreDNS fique em estado DEGRADED
